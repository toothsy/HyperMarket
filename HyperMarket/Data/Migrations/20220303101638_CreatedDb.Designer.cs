...
namespace HyperMarket.Data.Migrations
{
    ...
    [Migration("20220303101638_CreatedDb")]
            ...
            modelBuilder.Entity("HyperMarket.DB.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            UserId = 2,
                            CreatedAt = new DateTime(2022, 3, 3, 15, 46, 38, 516, DateTimeKind.Local).AddTicks(5240),
                            CreatedBy = 1,
                            EmailId = "abhyasood.ab@gmail.com",
                            Password = "Nearbuy",
                            ReferredBy = "Daksh",
                            RoleId = 5,
                            UpdatedAt = new DateTime(2022, 3, 3, 15, 46, 38, 516, DateTimeKind.Local).AddTicks(5250),
                            UpdatedBy = 1,
                            UserName = "Abhya"
                        },
                        new
                        {
                            UserId = 3,
                            CreatedAt = new DateTime(2022, 3, 3, 15, 46, 38, 516, DateTimeKind.Local).AddTicks(5256),
                            CreatedBy = 1,
                            EmailId = "sushma.M@gmail.com",
                            Password = "Nearbuy",
                            ReferredBy = "Abhya",
                            RoleId = 5,
                            UpdatedAt = new DateTime(2022, 3, 3, 15, 46, 38, 516, DateTimeKind.Local).AddTicks(5257),
                            UpdatedBy = 1,
                            UserName = "Sushma"
                        });
                });
