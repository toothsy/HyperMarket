    ...
    public partial class CreatedDb : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "tblUser",
                columns: new[] { "UserId", "CreatedAt", "CreatedBy", "EmailId", "Password", "ReferredBy", "RoleId", "UpdatedAt", "UpdatedBy", "UserName" },
                values: new object[] { 2, new DateTime(2022, 3, 3, 15, 46, 38, 516, DateTimeKind.Local).AddTicks(5240), 1, "abhyasood.ab@gmail.com", "Nearbuy", "Daksh", 5, new DateTime(2022, 3, 3, 15, 46, 38, 516, DateTimeKind.Local).AddTicks(5250), 1, "Abhya" });

            migrationBuilder.InsertData(
                table: "tblUser",
                columns: new[] { "UserId", "CreatedAt", "CreatedBy", "EmailId", "Password", "ReferredBy", "RoleId", "UpdatedAt", "UpdatedBy", "UserName" },
                values: new object[] { 3, new DateTime(2022, 3, 3, 15, 46, 38, 516, DateTimeKind.Local).AddTicks(5256), 1, "sushma.M@gmail.com", "Nearbuy", "Abhya", 5, new DateTime(2022, 3, 3, 15, 46, 38, 516, DateTimeKind.Local).AddTicks(5257), 1, "Sushma" });
